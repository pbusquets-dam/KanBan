...
namespace kanbanVS.APIClient
{
    public class UsersApiClient
    {
        ...
        public async Task<string> GetPasswordAsyncByUsername(string Username)
        {
            string Contrasenya;
        ...
        public async Task<User> GetTascaAsyncById(int Id)
        {
            User user = new User();
        ...
        /// <param name="user">Usuari que volem modificar</param>
        /// <returns></returns>
        public async Task DeleteTascaAsync(int Codi)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(BaseUri);
